...
COPY docker/php/wishlist.ini /etc/php/8.1/cli/conf.d/99-wishlist.ini
COPY docker/php/wishlist.ini /etc/php/8.1/fpm/conf.d/99-wishlist.ini
COPY docker/php/fpm.conf /etc/php/8.1/fpm/pool.d/zzz-wishlist.conf
...
COPY docker/php/xdebug.ini /etc/php/8.1/cli/conf.d/99-wishlist-xdebug.ini
COPY docker/php/xdebug.ini /etc/php/8.1/fpm/conf.d/99-wishlist-xdebug.ini
